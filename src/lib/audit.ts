...
export async function logActividad(supabase: any, params: {
  user_email: string
  entity:     'cliente' | 'plan' | 'pago' | 'sistema' | 'modulo_catalogo' | 'modulo_cliente' | 'diagnostico_necesidad' | 'lead' | 'ampliacion' | 'usuario' | 'presupuesto' | 'propuesta' | 'captura' | 'firma' | 'nivel'
