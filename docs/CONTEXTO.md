...
- **Gaps conocidos (Fase 4):** no hay expiración automática (nada pasa a VENCIDO al caducar) ni acción de cancelar → el bloqueo exige suspender a mano; el gate del selector de productos por módulo Inventario está pendiente.
