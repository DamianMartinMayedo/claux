/**
 * Cabecera propia de las páginas legales: solo la marca.
 *
 ...
 * costumbre y acaba en la web comercial. La salida es «Volver», que está donde
 * empieza el texto — aquí arriba se leería como cromo, no como la salida de esta
 * página, y de paso escondería el título.
 */
