...
import { Pencil, Plus, RotateCcw, Trash2, UserMinus, Users, Search, Wallet, X } from 'lucide-react'
      ...
      {tab === 'personal' ? (
        ...
        <div className="card card-table">
          <div className="mon-empty">
            ...
            <p>La nómina llega en la siguiente entrega de este módulo. Pronto podrás generar la nómina del período a partir de tu personal activo.</p>
          </div>
        </div>
      )}
